...
const IMAGES = [
  "https://images.unsplash.com/photo-1455656678494-4d1d8c8e7ad3?auto=format&fit=crop&w=400&q=80",
...
const priceRanges = [
  { label: 'Under ₹3,000', count: 25 },
  { label: '₹3,001 - ₹6,000', count: 134 },
  { label: '₹6,001 - ₹10,000', count: 89 },
  { label: 'Above ₹10,000', count: 45 }
];

const productTypes = [
  { label: 'Bracelets', count: 293, checked: true },
...
export default function Bracelets() {
  return (
    <div className="bg-ms-cream min-h-screen">
      <Head>
        <title>Bracelets Collection - Mangarule Saraf</title>
      </Head>
      <div className="max-w-7xl mx-auto py-8 px-4">
        <h1 className="section-heading text-center mb-8">Bracelets Collection</h1>
          ...
          <div className="w-64 bg-white rounded-xl shadow-ms-card p-6 h-fit sticky top-4">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                <button className="text-xs text-ms-gold hover:text-ms-dark">5 More ↓</button>
              </div>
            </div>
