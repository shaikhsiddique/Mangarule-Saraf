...
const priceRanges = [
  { label: 'Under ₹2,000', count: 28 },
  { label: '₹2,001 - ₹3,000', count: 156 },
  { label: '₹3,001 - ₹5,000', count: 89 },
  { label: 'Above ₹5,000', count: 12 }
];

const productTypes = [
  { label: 'Daily Wear', count: 285, checked: true },
...
export default function DailyWear() {
  return (
    <div className="bg-ms-cream min-h-screen">
      <Head>
        <title>Daily Wear Jewelry - Mangarule Saraf</title>
      </Head>
      <div className="max-w-7xl mx-auto py-8 px-4">
        <h1 className="section-heading text-center mb-8">Daily Wear Jewelry</h1>
          ...
          <div className="w-64 bg-white rounded-xl shadow-ms-card p-6 h-fit sticky top-4">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                ...
                <button className="text-xs text-ms-gold hover:text-ms-dark">3 More ↓</button>
              </div>
            </div>
